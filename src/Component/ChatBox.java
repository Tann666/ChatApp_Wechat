...
public class ChatBox extends JComponent {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (boxType == BoxType.LEFT) {
            ...
            g2.setPaint(new GradientPaint(0, 0, new Color(153, 255, 255, 255), width, 0, new Color(204, 204, 255, 255)));            
            g2.fill(area);
        } else {
            ...
            g2.setPaint(new GradientPaint(0, 0, new Color(204, 204, 255, 255), width, 0, new Color(153, 153, 255, 255)));
            g2.fill(area);
        }
        g2.dispose();
