...
import Animation.AnimationFloatingButton;
import Animation.AnimationScroll;
...
public class ChatArea extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        labelTitle.setFont(new Font(Font.SANS_SERIF, Font.BOLD | Font.ITALIC, 18));
        labelTitle.setBorder(new EmptyBorder(2, 10, 2, 2));
        labelTitle.setForeground(new Color(102, 102, 102));
    ...
    private JPanel createBottom() {
        RoundPanel panel = new RoundPanel();
        panel.setBackground(new Color(255, 255, 255, 20));
        panel.setLayout(new MigLayout("fill, inset 2", "[fill,40!]2[fill,40!]2[fill]2[fill,40!]", "[bottom]"));
        GoogleMaterialIcon iconFile = new GoogleMaterialIcon(GoogleMaterialDesignIcon.ATTACH_FILE, GradientType.VERTICAL, new Color(102, 153, 255), new Color(102, 153, 255), 25);
        GoogleMaterialIcon iconSend = new GoogleMaterialIcon(GoogleMaterialDesignIcon.SEND, GradientType.VERTICAL, new Color(102, 153, 255), new Color(102, 153, 255), 25);
        GoogleMaterialIcon iconEmot = new GoogleMaterialIcon(GoogleMaterialDesignIcon.INSERT_EMOTICON, GradientType.VERTICAL, new Color(102, 153, 255), new Color(102, 153, 255), 25);
        ...
        textMessage.setForeground(new Color(51, 51, 51));
        textMessage.setHint("Write a message...");
        ...
        cmdEmot.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                runEventMousePressedEmotButton(e);
            }
        });
    ...
    private void runEventMousePressedEmotButton(ActionEvent evt) {
        for (ChatEvent event : events) {
            event.mousePressedEmotButton(evt);
        }
    }
